...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortti_nollautuu_oikein_syo_edullisesti(self):
        jaljella = Maksukortti(2.5)
        jaljella.syo_edullisesti()
        self.assertEqual(str(jaljella), "Kortilla on rahaa 0.0 euroa")

    def test_kortti_nollautuu_oikein_syo_maukkaasti(self):
        jaljella = Maksukortti(4)
        jaljella.syo_maukkaasti()
        self.assertEqual(str(jaljella), "Kortilla on rahaa 0 euroa")
